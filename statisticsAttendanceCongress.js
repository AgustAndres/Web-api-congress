...
function congressAttendanceTables() {
...
function leastCongressAttendanceB(least) {
    var html = leastCongressAttendance(least);
    document.getElementById("least").innerHTML = html;
} 
leastCongressAttendanceB(least); 

function leastCongressAttendanceC(most) {
    var html = leastCongressAttendance(most);
    document.getElementById("most").innerHTML = html;
} 

leastCongressAttendanceC(most);